    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-background"><img src="assets/img/slide/slide.svg" alt=""></div>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">OUR BRANCHES</h2><p><a href="" target="_blank">Learn More...</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            <div class="skills-content">
              <p class="text-secondary"><b>Rating: </b></p>
              <div class="progress">
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box" style="background-color: #000;">
              <i class="icofont-simple-smile" style="color: #fff;"></i>
              <span data-toggle="counter-up">1500</span>
              <p style="color: #fff;"><strong>Happy Customers</strong></p>
            </div>
          </div>

          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box" style="background-color: #000;">
              <i class="icofont-document-folder" style="color: #fff;"></i>
              <span data-toggle="counter-up">24</span>
              <p style="color: #fff;"><strong>Items</strong></p>
            </div>
          </div>

          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box" style="background-color: #000;">
              <i class="icofont-live-support" style="color: #fff;"></i>
              <span data-toggle="counter-up">1,463</span>
              <p style="color: #fff;"><strong>Hours Of Support</strong></p>
            </div>
          </div>

          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box" style="background-color: #000;">
              <i class="icofont-users-alt-5" style="color: #fff;"></i>
              <span data-toggle="counter-up">15</span>
              <p style="color: #fff;"><strong>Hard Workers</strong></p>
            </div>
          </div>
