              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                    ...
                    <div class="contact-box p-4">
                      ...
                      <form action="partials/_manageContactUs.php" method="POST">
                        <div class="row">
                          ...
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-success mt-3 mb-3 text-white border-0 py-2 px-3"><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                              <button type="button" class="btn btn-success mt-3 mb-3 text-white border-0 py-2 px-3 mx-2" data-toggle="modal" data-target="#history"><span> HISTORY <i class="ti-arrow-right"></i></span></button>
                            </div>
                          <?php }else { ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-success mt-3 text-white border-0 py-2 px-3" disabled><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background:black">
                          <div class="detail-box p-4">
                           ...
                           <div class="round-social light">
                              ...
                              <a href="" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-facebook"></i></i></a>
                              <a href="" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-instagram"></i></a>
                            </div>
                          </div>
                        </div>';
                  ?>
