...
<body>
    ...
    <div class="container my-3">
        <h2 class="py-2" style="color: #fff;">Search Result for <em>"<?php echo $_GET['search']?>"</em> :</h2>
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            ...
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
                ?><script> document.getElementById("iteam").innerHTML = '<span style="color: #fff;">Items:</span>';</script> <?php
                $noResult = false;
                $pizzaId = $row['pizzaId'];
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3 ">
                    <div class="card" style="width: 18rem; background-color:#000;" >
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="color: #fff">' . substr($pizzaName, 0, 20). '...</h5>
                            <h6 style="color: #ff0000">Rs. '.$pizzaPrice. '/-</h6>
                            <p class="card-text" style="color: #fff">' . substr($pizzaDesc, 0, 29). '...</p>
                                ...
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        echo '<form action="partials/_manageCart.php" method="POST">
                                              ...
                                              <button type="submit" name="addToCart" class="btn btn-primary mx-2" style="width: 120px;">Add to Cart</button>';
                                    }else {
                                        echo '<a href="viewCart.php"><button class="btn btn-primary mx-2" style="width: 120px;">Go to Cart</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="btn btn-primary mx-2" data-toggle="modal" data-target="#loginModal" style="width: 120px;">Add to Cart</button>';
                                }
                                echo '</form>
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '"><button class="btn btn-primary" style="width: 120px;">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
